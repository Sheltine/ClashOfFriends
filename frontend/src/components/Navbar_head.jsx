...
class NavbarHead extends React.Component {
  ...
  render() {
    ...
    const renderMenu = (
      ...
      >
        <MenuItem onClick={this.handleMenuClose}><Link to="/profile">{JSON.parse(localStorage.getItem('currentUser')).username}</Link></MenuItem>
        <MenuItem onClick={this.handleMenuClose}><Link to="/connexion">Logout</Link></MenuItem>
      </Menu>
    );
