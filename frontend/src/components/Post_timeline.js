...
comments.push(new Comment("1", "Marina", "Cimer"));
 ...
 function displayContent(category, content) {
    switch(category) {
      ...
      case 'picture':
        return <div className="pull-right"><img className="PicChallenge-icon" src={content} height="150em" width="150em" /></div>;
      case 'video':
    ...
    return (
      <div>
        ...
        <div className="Post-div">
          <div className = "row">
            <p bsSize="small">{this.props.player1} {this.props.gameResult} against {this.props.player2}</p>
